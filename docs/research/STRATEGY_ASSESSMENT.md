...
| Phase 3（方法實驗） | D1 兩 primary lexical/objective、Multi-News cheap-multiroute 已完成；GovReport cheap-multiroute 11 success + G11 structural failure，cap-aware G11b 已獨立預註冊並完成。兩資料集 hard-pool graph 對純 lexical base 分別 `+0.013952/+0.033897`，但 Multi-News 仍低 Lead、GovReport 仍低 Random；GovReport full/soft pool 成本約 G00 `13.28×` 且不勝全文 lexical。仍缺兩格 semantic、paired inference 及 **候選池對 greedy reference 的 recall@K** |
