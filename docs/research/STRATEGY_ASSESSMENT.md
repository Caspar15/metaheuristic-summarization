...
| Phase 3（方法實驗） | lexical/objective、graph、semantic 與 capacity follow-ups 已完成（保留 structural failures）。S02b 在 Multi-News `0.328077`、GovReport `0.417862`，均為目前 proposed 最高點估計；但成本高、非 route 純 ablation。semantic-direct selector 跨資料集刪除。仍缺 matched ablation、paired inference 及 **候選池對 greedy reference 的 recall@K** |
