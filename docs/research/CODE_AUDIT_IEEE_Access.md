...
| **F-9** | **repo 無任何 baseline 實作** | 🔴 成立 | 🟡 **部分解除** | baseline 程式已加入；Multi-News frozen-dev non-PLM 23/23 已完成，P08 勝 proposed S02b。PLM、GovReport、greedy reference 與完整 paired matrix 尚未完成，Gate 2 未通過 |
...
2. 🔴 **F-9 baseline 矩陣仍不完整** —— Multi-News frozen-dev non-PLM 23/23 已完成，且 P08 已勝 proposed S02b；PLM、GovReport、greedy reference 與完整 Gate 2 paired matrix 未完成，F-0 仍無法最終回答
...
23/23 已完成，P08 是目前最強完成 baseline；PLM、GovReport、greedy reference 與完整 paired
...
| **P1-1** baseline | 「必補 Lead-3、PacSum、SBERT centroid、LLM zero-shot」 | ✅ 同意。**補充**：稽核當時 repo 沒有 baseline（F-9）；現在 Multi-News frozen-dev non-PLM 23/23 已完成，但 PLM、GovReport、greedy reference 與完整 paired matrix 仍缺 |
...
3. **F-9（legacy 無 baseline、目前矩陣仍不完整）** —— 舊表不能回溯當作本地重現；Multi-News non-PLM 23/23 已補，Gate 2 尚缺 PLM、GovReport、greedy reference、paired significance 與正式兩-primary矩陣。
...
**375 local tests 全過（2026-08-09）且 PR #15 Linux CI 綠燈**；這只代表 correctness regression、10-document snapshot、內部
...
Multi-News frozen-dev non-PLM 23/23 已完成。PLM family、GovReport、greedy reference、paired
