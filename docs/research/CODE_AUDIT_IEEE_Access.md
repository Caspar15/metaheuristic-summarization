...
**421 local tests 全過（2026-08-09）且 PR #15 Linux CI 綠燈**；這只代表 correctness regression、10-document snapshot、內部
...
F-56 當時完整回歸 **394 passed**；目前為 **421 passed**（2026-08-09）。後續不得再用外層 terminate 調整 worker 數；讓 invocation
