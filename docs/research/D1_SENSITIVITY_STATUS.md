...
- L10 對 Random 三項都較高；對 Lead 的 R-1／R-Lsum 較高，但 R-2 仍低
  ...
  兩 primary non-PLM 已完成，但兩資料集 PLM 與 greedy reference 未完成，不能稱為
...
1. Gate 2：兩 primary non-PLM 各 23/23 已完成；Multi-News P08 高 S02b
   `0.003663`，GovReport LexRank 高 `0.033758`。接著完成兩資料集 PLM、Lead、Random 與
