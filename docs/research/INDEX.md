...
| 測試 | ✅ **459 local tests 全過**（2026-08-11）；PR #16 Linux CI 綠燈（2026-08-10），PR #17 clean-clone CI 修正待 rerun。新增 6 個 v2 freeze guards，F-70～F-72 均納入回歸 |
