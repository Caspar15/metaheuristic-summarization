...
| 測試 | ✅ **261 tests 全過**（PR #12 已合併於 master）；CI 已接 GitHub Actions |
| **baseline** | 🟡 **Phase 2 進行中** —— shared contract、CLI、Lead、Random、TextRank／LexRank 程式已進 master；Multi-News Lead governed artifact 已產出。TextRank／LexRank 正在修 offline tokenizer regression，舊分數只作 historical diagnostic；PacSum、SBERT+MMR、GovReport 與正式兩-primary runs 未完成，**Gate 2 未過** |
