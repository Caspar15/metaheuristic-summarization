...
hash 全部相同；加入兩 primary partition／greedy-reference／GovReport data-layer／A1/D1 runners／D1 inventory／document-aware position、Gate 2 audits 與 F-51～F-53 guards 後 388 tests passed。SBERT centroid-only 與 full-source SBERT-MMR
